...
describe('AI Question Generation', () => {
  ...
  describe('validateQuestion', () => {
    ...
    it('should reject question with correct answer not in options', () => {
      ...
      const validation = validateQuestion(question);
      expect(validation.isValid).toBe(false);
      expect(validation.errors.some(e => e.includes('Correct answer'))).toBe(true);
    });
  ...
  describe('assessDifficulty', () => {
    ...
    it('should assess hard questions with long text and calculations', () => {
      const question: Question = {
        ...
        subject: 'physics',
        difficulty: 'hard',
        questionText: 'Calculate the de Broglie wavelength of an electron moving with velocity 10⁶ m/s. Given: mass = 9.1 × 10⁻³¹ kg, h = 6.63 × 10⁻³⁴ Js. Use the formula λ = h/mv and show all steps in your calculation.',
  ...
  describe('classifySubject', () => {
    it('should classify physics questions', () => {
      const text = 'Calculate the force acting on a body with mass 5 kg and acceleration 2 m/s²';
  ...
  describe('validateQuestionDistribution', () => {
    it('should validate correct distribution', () => {
      const questions: Question[] = [
        ...generateQuestions({ subject: 'physics', difficulty: 'easy', count: 10 }),
        ...generateQuestions({ subject: 'chemistry', difficulty: 'medium', count: 10 }),
        ...generateQuestions({ subject: 'mathematics', difficulty: 'hard', count: 10 }),
      ];
    ...
    it('should detect incorrect total count', () => {
      const questions: Question[] = generateQuestions({ subject: 'physics', difficulty: 'easy', count: 5 });
    ...
    it('should detect incorrect subject distribution', () => {
      const questions: Question[] = [
        ...generateQuestions({ subject: 'physics', difficulty: 'easy', count: 20 }),
        ...generateQuestions({ subject: 'chemistry', difficulty: 'easy', count: 5 }),
        ...generateQuestions({ subject: 'mathematics', difficulty: 'easy', count: 5 }),
      ];
